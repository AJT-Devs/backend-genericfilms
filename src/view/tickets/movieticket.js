...
<body>
    <div id="preview-ticket-div">
        <div class="ticket">
            ...
            <h1>Ingresso [Inteiro  - A1 - Sala N]</h1>

            <div class="information-session">
                <div class="img-poster-div">
                    <img src="" id="img-poster">
                </div>
                <div class="other-informations">
                    <h2>Informações da sessão</h2>
                    <ul>
                        <li>[Titulo do filme escolhido]</li>
                        <li>[Sab, 24 de maio - 13h00]</li>
                        <li>[Localização]</li>
                        <li>[Endereço, Cidade, uf]</li>
                        <li>[Sala N]</li>
                        <li>[2D - Dublado]</li>
                    </ul>
                </div>
            ...
            <div class="group-information">
                <h2>Ingresso</h2>
                <img src="../../icons/qrcode-ticket-teste.png" alt="QR-Code do ingresso" class="qrcode-ticket">
            </div>

            <div class="group-information">
                <h2>Valor pago</h2>
                <p>[R$22,00]</p>
                <p class="information-valor-pago">*Ingresso tipo [INTEIRO], valor unitário de [R$22,00]</p>
            </div>

            <p id="id-ingresso-p">Ingresso [ID#0000]</p>
        </div>
    </div>
</body>
</html>`
