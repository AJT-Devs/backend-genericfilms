...
select * from movie;
insert into movie values(default, "Kung Fu Panda", 120, "urldotrailer", "show de bolice", "jackie chan", "2025-05-05", "18", "panda", "autobot", "http://localhost:3000/uploads/angelo-1748818165294.jpg");
